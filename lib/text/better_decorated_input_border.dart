...
class BetterDecoratedInputBorder extends InputBorder {
  BetterDecoratedInputBorder({
    required this.child,
  ...
  InputBorder copyWith(
      ...
      BoxShadow? shadow,
      bool? isOutline}) {
    return BetterDecoratedInputBorder(
  ...
  bool operator ==(Object other) {
    ...
    return other is BetterDecoratedInputBorder &&
  ...
  @override
  String toString() {
    return 'DecoratedInputBorder{child: $child, shadow: $shadow}';
  }
}

extension XInputBorder on InputBorder {
  InputBorder shadow({BoxShadow? shadow, bool hasShadow = true}) {
    if (!hasShadow) {
      return this;
    }
    return BetterDecoratedInputBorder(
        ...
        shadow: shadow ??
            const BoxShadow(
                color: Color.fromRGBO(96, 96, 96, 0.17),
                offset: Offset(0, 4),
                blurRadius: 14));
  }
}
